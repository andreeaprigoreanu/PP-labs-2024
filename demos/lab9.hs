...
{-
    Polimorfism ad-hoc -> constrangere ca 'a' sa fie membru al clasei Eq
-}
elem_ :: Eq a => a -> [a] -> Bool
elem_ _ []       = False
...
clasa Functor - aplica o funcție pe fiecare din elementele unui container 
                pentru a obtine un nou container cu aceeași forma,
                dar cu alt continut
fmap - generalizare a functionalei map
...
{-
    5 :: Num p => p
    Numerele sunt constante polimorfice,
    adica ele pot avea tipuri care sunt instante ale clasei Num (Int, Integer, Float, Double)
